...
object RunRecommender {
        ...
        def main(args: Array[String]): Unit = {
                ...
                if (args.length == 0) {
                        println("dude, I need  the userID as argument")
                }
                val user_id = args(0).toInt
                ...
                println("\npreparing....\n")
                runRecommender.preparation(rawUserArtistData, rawArtistData, rawArtistAlias, user_id)

                println("\nmodeling....\n")
                runRecommender.model(rawUserArtistData, rawArtistData, rawArtistAlias, user_id)

                println("\nevaluating....\n")
                runRecommender.evaluate(rawUserArtistData, rawArtistAlias, user_id)

                println("\nrecommending....\n")
                runRecommender.recommend(rawUserArtistData, rawArtistData, rawArtistAlias, user_id)
